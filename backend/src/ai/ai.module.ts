...
@Module({
  providers: [HintsService, LlmProviderFactory, AiGenerateService],
  controllers: [HintsController, AiGenerateController],
  exports: [HintsService, AiGenerateService, LlmProviderFactory],
})
